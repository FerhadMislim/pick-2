...
csv_filename = f"lottery_all_results.csv"
...
for year in range(2012, current_year + 1):
    ...
    scrape_and_save_lottery_results(year, "midday", csv_filename)
    scrape_and_save_lottery_results(year, "evening", csv_filename)
